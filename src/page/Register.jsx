...
const Register = () => {
    ...
    const handleGoogle = async () => {
        ...
        try {
            ...
            toast(
                "স্বাগতম! ব্লাড ডোনার নেটওয়ার্কে যুক্ত হতে নিচের তথ্য গুলো পূরণ করুন। 💕",
                {
                    icon: <BiSolidDonateHeart className="text-3xl"></BiSolidDonateHeart>,
                    duration: 4500,
                    style: {
                        background: "#fef2f2",
                        color: "#991b1b",
...
// return firebase error messages 
